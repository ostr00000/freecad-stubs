...
class pyqtSignal(typing.Generic[Fun_t]):
    ...
    @typing.overload
    def __get__(self, instance: QObject, owner: type[QObject]) -> pyqtBoundSignal[Fun_t]: ...
...
class pyqtBoundSignal(typing.Generic[Fun_t]):
    ...
    @typing.overload
    def disconnect(self, slot: Fun_t | pyqtBoundSignal[typing.Any] | QMetaObject.Connection) -> None: ...
