...
class TopoShape(FreeCAD.ComplexGeoData):
    ...
    * Face#, where # is in range(1, number of faces)"""
    ...
    @typing.overload
    def section(self, tool: Part.TopoShape, /): ...

    @typing.overload
    def section(self, arg: Part.TopoShape, tolerance: float, /): ...

    @typing.overload
    def section(self, arg: object, tolerance: float = 0.0, /):
    ...
    def writeInventor(self, arg1: int = None, arg2: float = None, arg3: float = None, /):
...
class TopoShape(Part.TopoShape):
    ...
    def approximate(self, arg1: float, arg2: float, arg3: int, arg4: int, /):
...
class GeometrySurface(Part.Geometry):
    ...
    def toBSpline(self, arg1: float, arg2: str, arg3: str, arg4: int, arg5: int, arg6: int, arg7: int = None, /):
        """
...
def makeRevolution(Curve: Part.Geometry, vmin: float = None, vmax: float = None, angle: float = None, pnt: FreeCAD.Vector = None, dir: FreeCAD.Vector = None, shapetype: type = None, /):
