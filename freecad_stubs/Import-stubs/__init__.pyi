...
# AppImportPy.cpp
def open(arg1: str, arg2: str = None, /) -> list[tuple[object, FreeCAD.PropertyColorList]] | None:
    """open(string) -- Open the file and create a new document."""


def insert(string: str, string1: str = None, /) -> list[tuple[object, FreeCAD.PropertyColorList]] | None:
