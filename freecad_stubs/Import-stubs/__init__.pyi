...
def open(name: str, docName: str = None, importHidden=None, merge=None, useLinkGroup=None, mode: int = -1) -> list[tuple[typing.Any, FreeCAD.PropertyColorList]] | None:
    """
...
def insert(name: str, docName: str = None, importHidden=None, merge=None, useLinkGroup=None, mode: int = -1) -> list[tuple[typing.Any, FreeCAD.PropertyColorList]] | None:
    """
