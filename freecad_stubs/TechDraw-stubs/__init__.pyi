...
class DrawViewAnnotation(TechDraw.DrawView):
    ...
    def LineSpace(self) -> int:
        ...
        Line spacing adjustment. 100 is normal spacing.
        """
    ...
    def MaxWidth(self) -> float:
        ...
        The maximum width of the Annotation block.
        """
...
class DrawViewDimension(TechDraw.DrawView):
    ...
    def OverTolerance(self, value: float): ...
    ...
    def UnderTolerance(self, value: float): ...
...
class DrawView(FreeCAD.DocumentObject):
    ...
    def X(self) -> float:
        ...
        Property group: Base.
        Property TypeId: App::PropertyFloat.
        X position of the view on the page in internal units (mm).
        """
    ...
    def Y(self) -> float:
        ...
        Property group: Base.
        Property TypeId: App::PropertyFloat.
        Y position of the view on the page in internal units (mm).
        """
