...
class Face(PartModule.Shape):
    ...
    def addWire(self, arg1: PartModule.Wire, /):
...
class Shape(FreeCAD.ComplexGeoData):
    ...
    * Face#, where # is in range(1, number of faces)
    ...
    def countElement(self, arg1: str, /) -> int:
    ...
    def distToShape(self, Shape_s: PartModule.Shape, /) -> tuple[float, list[tuple[FreeCAD.Vector, FreeCAD.Vector]], list[tuple[str, int, float | tuple[float, float] | None, str, int, float | tuple[float, float] | None]]]:
        """
    ...
    def proximity(self, arg1: PartModule.Shape, arg2: float = None, /) -> tuple[list[int], list[int]]:
        """
...
class Wire(PartModule.Shape):
    ...
    def approximate(self, Tol2d: float = None, Tol3d: float = None, MaxSegments: int = None, MaxDegree: int = None) -> PartModule.BSplineCurve:
        """
